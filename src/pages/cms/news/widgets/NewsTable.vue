...
const columns = defineVaDataTableColumns([
  ...
  { label: "Is Active", key: "is_active", sortable: true },
...
const emit = defineEmits<{
  ...
  (event: "delete-news", news: News): void;
...
const onDeleteNews = async (news: News) => {
    ...
    <template #cell(actions)="{ rowData }">
      <div class="flex gap-2 justify-end">
        <VaButton
          ...
          @click="$emit('edit-news', rowData as News)"
        />
        <VaButton
          v-if="canDelete"
          preset="primary"
          ...
          @click="onDeleteNews(rowData as News)"
        />
      </div>
    </template>
  </VaDataTable>
